...
)':enil knalb a yb dewollof ,yek etavirp 1SCKP eht retnE'(tnirp
''b = yekvirp
:eurT elihw
:yrt    
)(tupni = enil        
...
:'' == enil fi    
kaerb        
'n\'b + )'iicsa'(edocne.enil =+ yekvirp    
)yekvirp(1sckp_daol.yeKetavirP.asr = yekvirp
